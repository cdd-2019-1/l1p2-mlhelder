...
polititicos_filter %>% filter(partido == "PSL" | partido == "PT" | partido == "MDB"| partido == "PSDB") %>% ggplot(aes(x = seguidores , y=engaj_max, color=partido)) + geom_point() + scale_y_log10() + scale_x_log10() + facet_grid(partido ~.)
  labs(
    title="Engajamento máximo x Partido",
    y="Engajamento total de retweets", 
    x="Partidos")
